...
- data: |-
    ...
    pipeline:
      - TrioCanu in canu 1.8+298 (mat_c0, pat_c0)
      - Arrow wi binned reads (no unknowns) (mat_c1, pat_c1)
      - purge_dups (mat_p1, pat_p1)
      - Added MT on each haplotype
      - scaff10x (mat_s1, pat_s1)
      - Solve (mat_s2, pat_s2)
      - Salsa 2.2 (mat_s3, pat_s3)
      - Arrow wi binned reads (t1)
      - Longranger wi binned reads + Freebayes, Merfin on both haps (t2 - asm.20210721)
    stats: |
      Merqury QV mat 40.8, pat 40.5
  ident: md17
...
- data: |
    data:
      pacbio:
        data:
        - N50_length (bp): 33097.0
          name: m54307_190403_184421.subreads.bam
          reads: 485861
          yield (bp): 10228844628
        - N50_length (bp): 31041.0
          name: m54307_190404_045842.subreads.bam
          reads: 563118
          yield (bp): 10839133193
        - N50_length (bp): 29336.0
          name: m54307_190404_192705.subreads.bam
          reads: 630264
          yield (bp): 11666796159
        - N50_length (bp): 30243.0
          name: m54307_190405_054135.subreads.bam
          reads: 615889
          yield (bp): 11798013600
        - N50_length (bp): 30788.0
          name: m54306_190405_175042.subreads.bam
          reads: 511128
          yield (bp): 10054026028
        - N50_length (bp): 28833.0
          name: m54307_190405_155618.subreads.bam
          reads: 618669
          yield (bp): 11358323672
        - N50_length (bp): 30934.0
          name: m54306_190406_142046.subreads.bam
          reads: 536130
          yield (bp): 10601291500
        - N50_length (bp): 27341.0
          name: m54307_190406_021106.subreads.bam
          reads: 620788
          yield (bp): 10692705174
        - N50_length (bp): 31005.0
          name: m54306_190406_040526.subreads.bam
          reads: 561194
          yield (bp): 11027525731
        - N50_length (bp): 27959.0
          name: m54307_190406_122536.subreads.bam
          reads: 629805
          yield (bp): 11068718898
        - N50_length (bp): 30858.0
          name: m54306_190407_105112.subreads.bam
          reads: 568152
          yield (bp): 11128145287
        - N50_length (bp): 30836.0
          name: m54306_190407_003613.subreads.bam
          reads: 547750
          yield (bp): 10826379679
        - N50_length (bp): 30272.0
          name: m54306_190407_210635.subreads.bam
          reads: 558238
          yield (bp): 10809087621
        - N50_length (bp): 29136.0
          name: m54307_190406_224006.subreads.bam
          reads: 624662
          yield (bp): 11536236895
        - N50_length (bp): 30796.0
          name: m54306_190408_072149.subreads.bam
          reads: 578433
          yield (bp): 11375868807
        metadata:
        - name: m54307_190403_184421.subreads.bam
          datatype: clr
        - name: m54307_190404_045842.subreads.bam
        ...
        - name: m54306_190408_072149.subreads.bam
          datatype: clr
        summary:
          yield (bp): 165011096872
          reads: 8650081
          coverage (X): 57.78
      bionano:
        data:
          molecules:
          - name: rGopFla2_Saphyr_DLE1_2678875.bnx.gz
            yield (bp): 480946900000.0
            N50 (kb): 284.6
            density (labels/100kb): 14.99
          cmaps:
          - name: rGopFla2_Saphyr_DLE1_2857688.cmap
            length (Mb): 2586.645
            N50 (Mb): 84.098
        metadata:
        - name: rGopFla2_Saphyr_DLE1_2678875.bnx.gz
    ...
    - common_name: Mexican gopher tortoise
      ...
      organism: Gopherus flavomarginatus
      isolate: rGopFla2
      breed: ''
      dev_stage: juvenile
      sex: ''
      tissue: blood
      biomaterial_provider: University of Arizona
      collection_date: 18-07-31
      collected_by: Taylor Edwards
      birth_date: ''
      birth_location: ''
      lat_lon: 36.88 N 104.97 W
      store_cond: -80C
      treatment: ethanol
      description: Offspring of rGopFla1 and rGopFl3; Chihuahua, Mexico; Captive Bred
        - Turner Ranch, New Mexico
      specimen_voucher: ''
      geo_loc_name: 'USA: Raton, NM'
